        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="card" style="width: 87rem;">
                <div class="header">
                    ...
                    <a class="btn btn-info btn-fill" href="{{ route('equipement.create') }}">
                        <i class="fa fa-plus-circle"></i>{{ __('Ajouter un équipement') }}
                    </a>

                    <form class="form-inline my-2 my-lg-0 pull-right" action="{{ route('equipement.index') }}" method="get" role="search">
                        <input class="form-control mr-sm-2" type="search" name="term" placeholder="{{ __('Chercher la catégorie') }}" aria-label="Search">
                        <button class="btn btn-info btn-fill my-2 my-sm-0" type="submit">
